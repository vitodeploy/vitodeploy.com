...
If you want to test the beta version of Vito, You can use the `3.x` tag.
...
To switch to the latest code on the `3.x` branch, you need to switch the git branch to `3.x`:
